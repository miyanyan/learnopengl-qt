...
ModelLoading::ModelLoading(QWidget *parent)
      ...
      m_camera(this)
{
    ...
    for(int i = 0; i < 5; ++i){
        ...
        connect(m_radioButtons[i], &QRadioButton::clicked, this, &ModelLoading::handleRadio);
    }
...
void ModelLoading::initializeGL()
{
    if(!context()){
...
void ModelLoading::resizeGL(int w, int h)
{
    glViewport(0, 0, w, h);
}

void ModelLoading::paintGL()
{    
...
bool ModelLoading::event(QEvent *e)
{
    m_camera.handle(e);
    return QWidget::event(e);
}

void ModelLoading::handleRadio()
{
    //origin
