...
void DepthTesting::initializeGL()
{
    if(!context()){
    ...
    //shader初始化
    {
        ...
        QString fragshader = m_depthViewEnabled ? ":/4.advanced_opengl/1.1depth_testing/depth_testing_view.frag"
                                                : ":/4.advanced_opengl/1.1depth_testing/depth_testing.frag";
...
void DepthTesting::resizeGL(int w, int h)
{
    glViewport(0, 0, w, h);
}

void DepthTesting::paintGL()
{
...
bool DepthTesting::event(QEvent *e)
{
    m_camera.handle(e);
