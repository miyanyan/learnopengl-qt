#ifndef BLENDINGDISCARD_H
#define BLENDINGDISCARD_H
...
class BlendingDiscard : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core
{
    Q_OBJECT
public:
    Q_INVOKABLE BlendingDiscard(QWidget *parent = nullptr);
    ~BlendingDiscard();
protected:
