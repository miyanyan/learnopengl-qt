...
FramebuffersExercise1::FramebuffersExercise1(QWidget *parent)
      ...
      m_postProcessingId(0)
{
    ...
    connect(cBoxLine, &QCheckBox::clicked, this, &FramebuffersExercise1::handleLineMode);
...
void FramebuffersExercise1::paintGL()
{
    ...
    m_camera.setPitch(pitch + 180.0f);
...
bool FramebuffersExercise1::event(QEvent *e)
{
    m_camera.handle(e);
    return QWidget::event(e);
}

void FramebuffersExercise1::handleLineMode(bool flag)
{
    m_isLineMode = flag;
    update();
}
